...
if exist "%BATCH_PARENT_DIR%\target\twclient-dist.jar" set PORTABLE_CFG=true
if exist "%BATCH_DIR%\target\twclient-dist.jar" set PORTABLE_CFG=true

if exist "%BATCH_PARENT_DIR%\target\twclient-dist.jar" (
  set TTJAR=%BATCH_PARENT_DIR%\target\twclient-dist.jar
  goto ttstart
)
if exist "%BATCH_DIR%\target\twclient-dist.jar" (
  set TTJAR=%BATCH_DIR%\target\twclient-dist.jar
  goto ttstart
)
...
echo   in twclient-core directory.
echo.
goto error
